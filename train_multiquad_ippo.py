...
def main():
    ...
    default_reward_coeffs = {
        "distance_reward_coef": 20.15154716325228,
        "z_distance_reward_coef": 10.517689384582464,
        "safe_distance_coef": 2.3125043914841,
        "velocity_reward_coef": 2.2796423296195316,
        "up_reward_coef": 5.075833230264889,
        "linvel_reward_coef": 5.304798021057311,
        "ang_vel_reward_coef": 1.4514546082682611,
        "linvel_quad_reward_coef": 3.048102094443332,
        "taut_reward_coef": 3.130135114980729,
        "collision_penalty_coef": -1.6326491966744925,
        "smooth_action_coef": -1.2882189703864046,
        "action_energy_coef": -3.1540886007996436,
    }
    ...
    config = {
        ...
        "UPDATE_EPOCHS": 3,
        "ANNEAL_LR": True,
        "LR": 0.0005586952019724209,
        "ACTIVATION": "tanh",
        "MAX_GRAD_NORM": 0.5,
        "CLIP_EPS": 0.2690271520823287,
        "VF_COEF": 0.7053154158032693,
        "ENT_COEF": 0.006326823717011276,
        "GAMMA": 0.9978273718559496,
        "GAE_LAMBDA": 0.9607043658975558,
        "SEED": 0,
